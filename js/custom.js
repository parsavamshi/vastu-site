...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Shared text/image reveal effects for all pages
  const revealTargets = document.querySelectorAll(
    ".ast_vastu_info h1, .ast_vastu_info h2, .ast_vastu_info h3, .ast_vastu_info p, .ast_heading h1, .ast_heading p, .contact-hero h1, .contact-hero p, .contact-card h4, .contact-card p, .contact-card a"
  );
  const revealImages = document.querySelectorAll(
    ".ast_vastu_info img, .ast_vastu_box img, .ast_bannertext_wrapper img, .contact-card img, .contact-map iframe"
  );

  revealTargets.forEach((el) => el.classList.add("reveal-text"));
  revealImages.forEach((el) => el.classList.add("reveal-image"));
  ...
  document.querySelectorAll(".reveal-text, .reveal-image, .fade-left, .fade-right").forEach((el) => {
